...
import { formatChatTime, getInitials } from "./chatUtils";
        ...
        {loading ? (
          ...
          contacts.map((contact) => (
            <button
              ...
              className={`flex w-full gap-3 border-b border-[#F8CFA8] px-4 py-3 text-left transition-colors ${
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-sm text-gray-600">{contact.jobTitle}</p>
                <p className="truncate text-xs text-gray-500">
                  {contact.lastMessage || contact.company?.name || "Start the chat"}
                </p>
              </div>
            </button>
          ))
