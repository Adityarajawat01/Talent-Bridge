...
//   return (
//     <div className="p-5 rounded-md shadow-xl bg-white border border-[#FFE0C2]">
//       <div className="flex items-center justify-between">
//         <p className="text-sm text-gray-500">
//           {daysAgoFunction(job?.createdAt) == 0
//             ? "Today"
...
//         <Button
//           variant="outline"
//           className="rounded-full border-[#F8CFA8] text-[#D96B00] hover:bg-[#FFF3E0] hover:text-[#B45309]"
//           size="icon"
//         >
//           <Bookmark />
//         </Button>
...
//       <div className="flex items-center gap-2 my-2">
//         <Button
//           className="p-6 border-[#F8CFA8] hover:bg-[#FFF3E0]"
//           variant="outline"
//           size="icon"
//         >
//           <Avatar>
//             <AvatarImage src={job?.company?.logo} alt="jobImage" />
//           </Avatar>
//         </Button>
...
//           onClick={() => navigate(`/jobs/description/${job?._id}`)}
//           variant="outline"
//           className="border-[#F28C28] text-[#D96B00] hover:bg-[#FFF3E0] hover:text-[#B45309]"
//         >
//           Details
//         </Button>
//         <Button className="bg-[#7209b7]">Save For Later </Button>
